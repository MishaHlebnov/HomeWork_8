            ...
            protected void paintComponent (Graphics gr) {
                ...
                for (int x = 0; x < WIDTH_FIELD; x++) {
                    for (int y = 0; y < HEIGHT_FIELD; y++) {
                        ...
                        if (x == 0) gr.drawLine(0, y * SIZE_BLOCK,
                                WIDTH_FIELD * SIZE_BLOCK, y * SIZE_BLOCK);
                        if (y == 0) gr.drawLine(x * SIZE_BLOCK, 0,
                                x * SIZE_BLOCK, HEIGHT_FIELD * SIZE_BLOCK);
                        ...
                        if (Game.getField(new Coord(x, y)) == 2) {
                            ...
                            gr.fillOval(x * SIZE_BLOCK + 2, y * SIZE_BLOCK + 2,
                                    SIZE_BLOCK - 3, SIZE_BLOCK - 3);
                        }
                    }
                }
